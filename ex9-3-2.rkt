...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname ex9-3-2) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
; 9.3.1
...
; 9.3.2
; Reformulate the definition of contains-doll? according to the observation that
; (contains-doll? (rest a-list-of-symbols)) is a condition that evaluates to a bool
(define (contains-doll? los)
  (cond
    [(empty? los) false]
    [else (or (symbol=? (first los) 'doll)

...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname ex7-4-6) (read-case-sensitive #t) (teachpacks ((lib "draw.rkt" "teachpack" "htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "draw.rkt" "teachpack" "htdp")) #f)))
;; 7.4.1
...
(start 400 100)
(define circle-746 (make-circle (make-posn 50 50) 25 'black))
(draw-shape
 (move-shape 10
             (move-shape 10
                         (move-shape 10
                                     (move-shape 10
                                                 (move-shape 10 circle-746))))))
